...
criteria <- c("pH", "Temp", "EC", "TDS", "Salinity", "DO", "PO4", "NO3", "NH4", "TotalAlk", "TSS")

# Example raw data with participants P1 to P9
raw_data <- data.frame(
  P1 = c(8.5, 2, 8, 15, 8.5, 7, 9, 10, 8, 13, 11),
  P2 = c(0, 0, 20, 20, 20, 5, 15, 5, 5, 5, 5), 
  P3 = c(0, 0, 0, 10, 0, 20, 30, 20, 20, 0, 0),
  P4 = c(5, 5, 5, 5, 10, 6, 16, 15, 17, 11, 5),
  P5 = c(5, 5, 10, 10, 5, 8, 15, 15, 7, 5, 15),
  P6 = c(10, 0, 0, 30, 0, 0, 30, 30, 0, 0, 0),
  P7 = c(0, 0, 5, 5, 5, 11, 21, 21, 21, 6, 5),
  P8 = c(10, 3, 10, 10, 13, 8, 5, 9, 12, 10, 10),
  P9 = c(4, 4, 4, 10, 4, 12, 16, 16, 16, 4, 10),
  P10 =c(9, 9, 11, 12, 5, 7, 8, 5, 15, 11, 8)
)
...
export_ahp_matrices_to_excel <- function(ahp_matrices, filename = "AHP_Matrices_Rizal.xlsx") {
  wb <- createWorkbook()
