...
mydata <- read.csv("imputedStn15.csv", header = TRUE, row.names = NULL)
...
write.csv(imputed_data, file = "imputedStn15.csv", row.names = FALSE)

# Perform PCA
pca <- PCA(mydata[,-1], graph = FALSE)
pca
